...
export default function Button({
  ...
  const buttonClasses = clsx(
    ...
    className,
    {
      ...
      "bg-yellow-300 text-black hover:bg-grey-4 focus:ring-2 focus:ring-white-500 focus:ring-offset-2": 
        variant === "primary",
      ...
      "bg-color-primary text-white-600 border border-yellow-200 hover:bg-white-100": 
       ...
       "w-full bg-yellow-400 hover:bg-yellow-500 text-white py-3 px-4 rounded font-medium transition duration-200":
       variant === "real",
